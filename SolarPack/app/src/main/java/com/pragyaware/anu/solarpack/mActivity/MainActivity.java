...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout nav_gallery, nav_slideshow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nav_gallery = (LinearLayout) findViewById(R.id.nav_gallery);
        nav_slideshow = (LinearLayout) findViewById(R.id.nav_slideshow);
        nav_slideshow.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void logout() {
        ...
        builder.setPositiveButton("ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (PreferencesUtil.getInstance(MainActivity.this).isLoggedIn()) {
